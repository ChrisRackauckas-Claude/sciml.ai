...
So a generalized implementation of these strategies, like TikTak and improving the ones mentioned
...
**Expected Results**: A suite of multistart methods available through the SciML EnsembleProblem interface.
...
and featureful as well as extending it to more solver wrappers. This project is quite open ended and can
...
predefined callbacks, using the state for non-standard stopping criteria in global optimization etc.
